						...
						<div className="lc-block">
							<div id="carouselLogos" className="carousel slide pt-1 pb-4" data-bs-ride="carousel">
								...
								<ol className="carousel-indicators position-relative mt-3">
									<li data-bs-target="#carouselLogos" data-bs-slide-to="0" className="active bg-secondary carousel-control-prev-icon"></li>
									<li data-bs-target="#carouselLogos" data-bs-slide-to="1" className="bg-secondary"></li>
									<li data-bs-target="#carouselLogos" data-bs-slide-to="2" className="bg-secondary"></li>
									<li data-bs-target="#carouselLogos" data-bs-slide-to="3" className="bg-secondary"></li>
								</ol>
								...
								<div className="w-100 px-3 text-center mt-4">
									<a className="carousel-control-prev position-relative d-inline me-4" href="#carouselLogos" data-bs-slide="prev">
										<svg width="2em" height="2em" viewBox="0 0 16 16" className="text-secondary" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
