        ...
        <div className="row">
          <div className="col-md-12">
            <div className="lc-block">
              <div
                id="carouselLogos"
                className="carousel slide pt-1 pb-4"
                  ...
                  <div className="carousel-item active p-0 m-0 ">
                    <div className="row ">
                      {arraymapeado.map((peli) => (
                        <div
                          className="col-6 col-lg-2 align-self-center p-0 m-0 "
                          key={`${peli.id}`}>
                          <img
                            className="d-block w-100 p-1 m-0 "
                ...
                <ol className="carousel-indicators position-relative mt-3">
                  <li
                    ...
                    data-bs-slide-to="0"
                    className="active bg-dark carousel-control-prev-icon"></li>
                  <li
                    data-bs-target="#carouselLogos"
                    data-bs-slide-to="1"
                    className="bg-dark"></li>
                  <li
                    data-bs-target="#carouselLogos"
                    data-bs-slide-to="2"
                    className="bg-dark"></li>
