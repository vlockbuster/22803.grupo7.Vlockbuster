...
switch (key) {
  ...
  const lista = [
    ...
    },
    {
      ...
      overview:
        "Top Gear. Programa de automóviles. Toda clase de pruebas con coches y resto de vehículos, incluyendo viajes a través de desiertos, caminos tortuosos. Experimentos con motores, lanzamientos por encima de caravanas....",
      popularity: 91.421,
    ...
    },
    {
      ...
      overview:
        "Experimenta las maravillas de nuestro mundo como nunca antes en esta docuserie épica de Jon Favreau y los productores de Planet Earth. Viaja 66 millones de años atrás, cuando los majestuosos dinosaurios y las criaturas extraordinarias vagaban por las tierras, los mares y los cielos.",
      popularity: 67.548,
    ...
    },
    {
      ...
      overview:
        "El sultán otomano Mehmed II libra una campaña épica para tomar la capital bizantina de Constantinopla y cambia el curso de la historia durante siglos.",
      popularity: 77.293,
    ...
    },
    {
      ...
      overview:
        "Aborda la vida de Vicente Fernández —mejor conocido como «El Charro de Huentitán»—, el cual, a través de entrevistas, testimonios y revelaciones inéditas, se cuenta como antes de llegar a cantar en el Estadio Azteca pintaba casas, de un matrimonio estable a varios amores tormentosos y de enmendar su ausencia como padre cuando se encomendó a Dios para salvar la vida de uno de sus hijos.",
      popularity: 57.678,
    ...
    },
    {
      ...
      overview:
        "Un viaje a la isla de Vancouver, un entorno salvaje donde animales como águilas calvas y lobos costeros encuentran su alimento en las frías aguas del océano.",
      popularity: 44.022,
